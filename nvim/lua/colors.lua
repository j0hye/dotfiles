    ...
    local setups = {
        ["rose-pine"] = {
            ...
            highlight_groups = {
                ...
                BufferDefaultCurrentSign = { fg = "NONE", bold = "NONE" },
                BufferDefaultVisibleSign = { fg = "NONE", bold = "NONE" },
                BufferDefaultInactiveSign = { fg = "NONE", bold = "NONE" },
                BufferDefaultCurrentSignRight = { fg = "NONE", bold = "NONE" },
                BufferDefaultVisibleSignRight = { fg = "NONE", bold = "NONE" },
                BufferDefaultInactiveSignRight = { fg = "NONE", bold = "NONE" },
                BufferDefaultAlternateSignRight = { fg = "NONE", bold = "NONE" },
            },
        },
        kanagawa = {
            transparent = true,
