    ...
    local setups = {
        ["rose-pine"] = {
            ...
            highlight_groups = {
                ...
                BufferDefaultCurrentSign = { fg = "NONE" },
                BufferDefaultVisibleSign = { fg = "NONE" },
                BufferDefaultInactiveSign = { fg = "NONE" },
                BufferDefaultCurrentSignRight = { fg = "NONE" },
                BufferDefaultVisibleSignRight = { fg = "NONE" },
                BufferDefaultInactiveSignRight = { fg = "NONE" },
                BufferDefaultAlternateSignRight = { fg = "NONE" },
            },
        },
        kanagawa = {
            transparent = true,
